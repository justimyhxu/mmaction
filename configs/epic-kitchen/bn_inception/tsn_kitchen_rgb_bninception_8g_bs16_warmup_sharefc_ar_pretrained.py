...
model = dict(
    ...
    backbone=dict(
        type='BNInception',
        pretrained='work_dirs/tsn_kitchen_rgb_bninception_8g_bs64_warmup_sharefc_AR/epoch_80_backbone.pth',
        bn_eval=False,
        partial_bn=True,
        all_frozen=False),
...
log_level = 'INFO'
work_dir = './work_dirs/tsn_kitchen_rgb_bninception_8g_bs16_warmup_sharefc_ar_pretrained_no_frozen'
load_from = None
resume_from = None
