...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='data/ava/ava_train_v2.1.csv',
        # ann_file='data/ava/ava_train_v2.1.example2.csv',
        exclude_file='data/ava/ava_train_excluded_timestamps_v2.1.csv',
        label_file='data/ava/ava_action_list_v2.1_for_activitynet_2018.pbtxt',
        video_stat_file='data/ava/ava_video_stats.csv',
        # proposal_file='data/dense_proposals_train.recall_92.pkl',
        proposal_file='data/dense_proposals_train.FAIR.recall_93.9.pkl',
    ...
    val=dict(
        type=dataset_type,
        ann_file='data/ava/ava_val_v2.1.csv',
        exclude_file='data/ava/ava_val_excluded_timestamps_v2.1.csv',
        # exclude_file='data/ava/ava_train_excluded_timestamps_v2.1.csv',
        label_file='data/ava/ava_action_list_v2.1_for_activitynet_2018.pbtxt',
        video_stat_file='data/ava/ava_video_stats.csv',
        # proposal_file='data/dense_proposals_val.recall_92.pkl',
        proposal_file='data/dense_proposals_val.FAIR.recall_93.9.pkl',
        img_prefix=data_root,
        img_norm_cfg=img_norm_cfg,
        input_format="NCTHW",
        new_length=32,
