...
data = dict(
    ...
    test=dict(
        ...
        label_file='data/ava/annotations/ava_action_list_v2.1_for_activitynet_2018.pbtxt',
        video_stat_file='data/ava/ava_video_resolution_stats.csv',
        proposal_file='data/ava/tracking_gt_part_ava_dense_proposals_train.FAIR.recall_93.9.pkl',
        img_prefix=data_root,
        img_norm_cfg=img_norm_cfg,
        input_format='NCTHW',
        new_length=32,
...
load_from = None
resume_from = 'work_dirs/ava_fast_rcnn_r50_c4_1x_kinetics_pretrain_tracking/epoch_3.pth'
workflow = [('train', 1)]
